            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    <p className="text-[9px] font-bold text-[#667085] uppercase tracking-tight">Status da Conta</p>
                    <div className="flex items-center gap-1.5 mt-0.5">
                      <span className="size-2 rounded-full bg-emerald-500 animate-pulse"></span>
                      <span className="text-xs font-bold text-emerald-750">Ativa / Operável</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    <p className="text-[9px] font-bold text-[#667085] uppercase tracking-tight">Nível Administrativo</p>
                    <p className="text-xs font-black text-[#1F2933] uppercase mt-0.5">
